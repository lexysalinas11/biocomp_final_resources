...
#challenge due fri
function(x,species,width){
  
}

#example using iris data
#number of ind. of a species w trait >1
treeCounts<-function(x,species,value){
...
treeCounts(x=myData,taxa="oak",value=0.5)

#value above is a specific number

#create subset of data w only oaks 
subset<-x[x$species==taxa]
...
#set variable and subset females and respective wages; do the same for males
#find sum for all females and all males 
...
# *Lec ?: Index Sequential Variables*
